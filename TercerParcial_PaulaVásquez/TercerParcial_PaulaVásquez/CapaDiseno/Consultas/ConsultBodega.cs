...
{
    public partial class ConsultBodega : Form
    {
        Logica logica = new Logica();
        public ConsultBodega()
        {
            InitializeComponent();
        ...
        {
            OdbcDataReader mostrar = logica.consulta4("1");
            try
            {
                while (mostrar.Read())
                {
        ...
        private void ConsultFacultad_Load(object sender, EventArgs e)
        {
            Dgv_consulta2.Rows.Clear();
            MostrarTabla();
        }
