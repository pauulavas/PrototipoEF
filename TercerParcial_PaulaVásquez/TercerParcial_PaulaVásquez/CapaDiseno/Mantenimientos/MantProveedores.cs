...
namespace CapaDiseno.Mantenimientos
{
    public partial class MantProveedores : Form
    {
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader cita = logic.modificar5(Txt_1.Text, Txt_2.Text, Txt_3.Text, Txt_4.Text, Txt_5.Text, Cbo_estado.Text);
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader cita = logic.guardar5(Txt_1.Text, Txt_2.Text, Txt_3.Text, Txt_4.Text, Txt_5.Text, Cbo_estado.Text);
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader cita = logic.eliminar5(Txt_1.Text);
        ...
        {
            ConsultProveedor concep = new ConsultProveedor();
            concep.ShowDialog();
