...
namespace CapaDiseno.Mantenimientos
{
    public partial class MantMarcas : Form
    {
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader cita = logic.modificar2(Txt_1.Text, Txt_2.Text, Cbo_estado.Text);
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader cita = logic.guardar2(Txt_1.Text, Txt_2.Text,  Cbo_estado.Text);
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            OdbcDataReader cita = logic.eliminar2(Txt_1.Text);
